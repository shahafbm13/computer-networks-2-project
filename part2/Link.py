...
class Link:
    ...
    def send_message_to_switch_part_2(self, message, target_switch, host_list, switch_list, link_list, print_flag=False,start_time = 0):
        # Send a message to a target switch
        target_switch.receive_message_part_2(message, self, host_list, switch_list, link_list, print_flag,start_time=start_time)
